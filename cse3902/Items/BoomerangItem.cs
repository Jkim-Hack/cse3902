...
namespace cse3902.Items
{
    public class BoomerangItem : ISprite, IItem
    {
        ...
        public BoomerangItem(SpriteBatch batch, Texture2D texture, Vector2 startingPos, bool kept, bool resetKept)
        {
            spriteBatch = batch;
        ...
        public void Draw()
        {
            ...
            Rectangle Destination = this.Box;
            // new Rectangle(currentX, currentY, (int)(sizeIncrease * frameWidth), (int)(sizeIncrease * frameHeight));
