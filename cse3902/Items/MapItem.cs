...
{
    public class MapItem : ISprite, IItem
    {
        ...
        public MapItem(SpriteBatch batch, Texture2D texture, Vector2 startingPos, bool kept, bool resetKept)
        {
            spriteBatch = batch;
            ...
            itemType = InventoryManager.ItemType.Map;
            isKept = kept;
