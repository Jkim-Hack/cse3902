...
namespace cse3902.Items
{
    public class HeartContainerItem : ISprite, IItem
    {
        ...
        public HeartContainerItem(SpriteBatch batch, Texture2D texture, Vector2 startingPos, bool kept, bool resetKept)
        {
            spriteBatch = batch;
            ...
            itemType = InventoryManager.ItemType.HeartContainer;
            isKept = kept;
