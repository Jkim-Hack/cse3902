...
{
    public class BlueCandleItem : ISprite, IItem
    {
        ...
        public BlueCandleItem(SpriteBatch batch, Texture2D texture, Vector2 startingPos, bool kept, bool resetKept)
        {
            spriteBatch = batch;
        ...
        {
            get => InventoryManager.ItemType.BlueCandle;
        }
