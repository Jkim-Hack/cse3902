...
namespace cse3902.Items
{
    public class RupeeItem : ISprite, IItem
    {
        ...
        public RupeeItem(SpriteBatch batch, Texture2D texture, Vector2 startingPos, bool kept, bool resetKept)
        {
            spriteBatch = batch;
            spriteTexture = texture;

            delays.delay = ItemConstants.RupeeDelay;

            delays.remainingDelay = delays.delay;
            this.dimensions.rows = ItemConstants.RupeeRows;
            this.dimensions.columns = ItemConstants.RupeeCols;
