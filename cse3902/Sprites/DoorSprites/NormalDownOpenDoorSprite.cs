...
namespace cse3902.Sprites
{
    public class NormalDownOpenDoorSprite : IDoorSprite
    {
        ...
        public NormalDownOpenDoorSprite(SpriteBatch spriteBatch, Texture2D blackTexture, Texture2D texture, Vector2 startingPosition, Rectangle wantedDoor, bool bombed)
        {
