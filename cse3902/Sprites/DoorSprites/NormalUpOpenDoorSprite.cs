...
namespace cse3902.Sprites
{
    public class NormalUpOpenDoorSprite : IDoorSprite
    {
        ...
        public NormalUpOpenDoorSprite(SpriteBatch spriteBatch, Texture2D blackTexture, Texture2D texture, Vector2 startingPosition, Rectangle wantedDoor, bool bombed)
        {
