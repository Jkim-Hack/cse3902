...
namespace cse3902.Sprites
{
    public class StaticStillSprite : ISprite
    {
        ...
        public StaticStillSprite(SpriteBatch spriteBatch, Texture2D texture, int rows, int columns)
        {
        ...
        public StaticStillSprite(SpriteBatch spriteBatch, Texture2D texture, int rows, int columns, Vector2 startingPosition)
        { 
            this.spriteBatch = spriteBatch;
	        spriteTexture = texture;
            speed = 100f;
