...
{
    public class StalfosSpawner : ISpawner
    {
        ...
        public StalfosSpawner(Game1 game, Vector2 startingPos, int count)
        {
            this.position = startingPos;
            easyCount = count;
            this.maxCount = count * SettingsValues.Instance.GetValue(SettingsValues.Variable.StalfosSpawnerCountMultiplier);
        ...
        public void Reset()
        {
            this.maxCount = easyCount * SettingsValues.Instance.GetValue(SettingsValues.Variable.StalfosSpawnerCountMultiplier);
        ...
        public void SpawnEnemy()
        {
            if (currCount > 0)
            {
                RoomEnemies.Instance.AddEnemy(new Stalfos(game, position));
                currCount--;
            }
        }
    }
