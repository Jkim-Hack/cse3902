...
namespace cse3902.Utilities
{
    public class HUDUtilities
    {
        ...
        public static void DrawTexture(Game1 game, Texture2D texture, Rectangle rec, int offsetX, int offsetY, float layer)
        {
            game.SpriteBatch.Draw(texture, new Rectangle(rec.X + offsetX, rec.Y + offsetY, rec.Width, rec.Height), null, Color.White, 0, new Vector2(), SpriteEffects.None, layer);
        }
    }
}
