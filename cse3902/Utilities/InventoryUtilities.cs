...
namespace cse3902.Utilities
{
    internal class InventoryUtilities
    {
        ...
        private readonly static Dictionary<ItemType, int> maxItems = new Dictionary<ItemType, int> { { ItemType.Rupee, 255 }, { ItemType.Bomb, 9 }, { ItemType.Key, 9 } };
        private readonly static Dictionary<ItemType, int> countPerItem = new Dictionary<ItemType, int> { { ItemType.Rupee, 1 }, { ItemType.Bomb, 4 } };
