...
{
    public class MagicBeamProjectile : IProjectile
    {
        ...
        public MagicBeamProjectile(SpriteBatch batch, Texture2D texture, Vector2 startingPos, Vector2 dir)
        {
            ...
            remainingDelay = ItemConstants.MagicBeamDelay;
            int rows = ItemConstants.MagicBeamRows;
            int columns = ItemConstants.MagicBeamCols;
            currentFrame = 0;
        ...
        public int Update(GameTime gameTime)
        {
            if (!collided)
            {
                ...
                current += direction * ItemConstants.MagicBeamSpeed;
                return 0;
            }
            else
            {
        ...
        public int Damage
        {
            get => DamageConstants.MagicBeamDamage;
